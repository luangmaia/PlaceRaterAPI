namespace PlaceRaterAPI.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Place_City = c.String(maxLength: 128),
                        Place_State = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Url)
                .ForeignKey("dbo.Places", t => new { t.Place_Name, t.Place_City, t.Place_State })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Images", new[] { "Place_Name", "Place_City", "Place_State" }, "dbo.Places");
            ...
            DropIndex("dbo.Images", new[] { "Place_Name", "Place_City", "Place_State" });
